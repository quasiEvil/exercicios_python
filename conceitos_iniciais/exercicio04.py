...
if salario_bruto <= 1903.98:
    ...
    print(f"Seu salário líquido é de R$ {faixa2:.2f} e sofre um desconto de 7,5%.")
elif salario_bruto >= 2826.66 and salario_bruto <= 3751.05:
    faixa3 = salario_bruto - (salario_bruto * 0.15)
    print(f"Seu salário líquido é de R$ {faixa3:.2f} e sofre um desconto de 15%.")
elif salario_bruto >= 3751.06 and salario_bruto <= 4664.68:
    faixa4 = salario_bruto - (salario_bruto * 0.225)
    print(f"Seu salário líquido é de R$ {faixa4:.2f} e sofre um desconto de 22,5%.")
elif salario_bruto > 4664.68:
    faixa5 = salario_bruto - (salario_bruto * 0.275)
    print(f"Seu salário líquido é de R$ {faixa5:.2f} e sofre um desconto de 27,5%.")
